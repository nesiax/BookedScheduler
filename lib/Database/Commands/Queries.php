...
class Queries
{
    ...
    const ADD_BLACKOUT_INSTANCE =
        'INSERT INTO "blackout_instances" ("start_date", "end_date", "series_id")
        VALUES (@startDate, @endDate, @seriesid)';

    const ADD_BLACKOUT_RESOURCE = 'INSERT INTO "blackout_series_resources" ("series_id", "resource_id") VALUES (@seriesid, @resourceid)';

    const ADD_EMAIL_PREFERENCE =
        'INSERT INTO "user_email_preferences" ("user_id", "event_category", "event_type") VALUES (@userid, @event_category, @event_type) ON CONFLICT DO NOTHING';
    ...
    const ADD_GROUP_ROLE =
        'INSERT INTO "group_roles" ("group_id", "role_id") VALUES (@groupid, @roleid) ON CONFLICT DO NOTHING';
...
//                    ("ri"."start_date" <= @startDate AND "ri"."end_date" >= @endDate)) LIMIT 1)';
    ...
    const ADD_USER_RESOURCE_PERMISSION =
        'INSERT INTO "user_resource_permissions" ("user_id", "resource_id", "permission_type")
        VALUES (@userid, @resourceid, @permission_type) ON CONFLICT DO NOTHING';

    const ADD_USER_TO_DEFAULT_GROUPS =
        'INSERT INTO "user_groups" ("user_id", "group_id") SELECT @userid, "group_id" FROM "groups" WHERE "isdefault"=TRUE ON CONFLICT DO NOTHING';
    ...
    const AUTO_ASSIGN_PERMISSIONS =
        ...
        SELECT @userid as "user_id", "resource_id" FROM "resources" WHERE "autoassign"=TRUE';
    ...
    const AUTO_ASSIGN_RESOURCE_PERMISSIONS =
        'INSERT INTO "user_resource_permissions" ("user_id", "resource_id")
            ...
            FROM
                "users" "u") ON CONFLICT DO NOTHING';
    ...
    const DELETE_BLACKOUT_SERIES = 'DELETE "blackout_series" FROM "blackout_series"
        INNER JOIN "blackout_instances" ON "blackout_series"."series_id" = "blackout_instances"."series_id"
    ...
    const DELETE_ORPHAN_LAYOUTS = 'DELETE FROM "layouts" USING "layouts" "l" LEFT JOIN "schedules" "s" ON "l"."layout_id" = "s"."layout_id" WHERE "layouts"."layout_id" = "l"."layout_id" and "s"."layout_id" IS NULL';
    ...
    const DELETE_RESOURCE_RESERVATIONS_COMMAND =
        ...
        USING "reservation_series" "s"
        INNER JOIN "reservation_resources" "rs" ON "s"."series_id" = "rs"."series_id"
        WHERE "reservation_series"."series_id" = "s"."series_id"
    ...
    const GET_ALL_ACCESSORIES =
        'SELECT "a".*, "c"."num_resources",
            (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("ra"."resource_id", \',\', COALESCE("ra"."minimum_quantity"::text,\'\'), \',\',  COALESCE("ra"."maximum_quantity"::text,\'\')) ), \'!sep!\')
    ...
    const GET_ALL_ANNOUNCEMENTS = 'SELECT "a".*,
            (SELECT ARRAY_TO_STRING(ARRAY_AGG("ag"."group_id"), \',\') FROM "announcement_groups" "ag" WHERE "ag"."announcementid" = "a"."announcementid") as "group_ids",
            (SELECT ARRAY_TO_STRING(ARRAY_AGG("ar"."resource_id"), \',\') FROM "announcement_resources" "ar" WHERE "ar"."announcementid" = "a"."announcementid") as "resource_ids"
    ...
    const GET_ALL_GROUPS =
        'SELECT "g".*, "admin_group"."name" as "admin_group_name",
            (SELECT ARRAY_TO_STRING(ARRAY_AGG("gr"."role_id"), \',\') FROM "group_roles" "gr" WHERE "gr"."group_id" = "g"."group_id") as "group_role_list"
        FROM "groups" "g"
    ...
    const GET_ALL_GROUP_USERS =
        'SELECT "u".*, (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("cav"."custom_attribute_id", \'=\', "cav"."attribute_value") ), \'!sep!\')
    ...
    const GET_ALL_RESOURCES =
        ...
        (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("cav"."custom_attribute_id", \'=\', "cav"."attribute_value") ), \'!sep!\')
                        FROM "custom_attribute_values" "cav" WHERE "cav"."entity_id" = "r"."resource_id" AND "cav"."attribute_category" = 4) as "attribute_list",
        (SELECT ARRAY_TO_STRING(ARRAY_AGG("rga"."resource_group_id" ), \'!sep!\') FROM "resource_group_assignment" "rga" WHERE "rga"."resource_id" = "r"."resource_id") AS "group_list",
        (SELECT ARRAY_TO_STRING(ARRAY_AGG("ri"."image_name" ), \'!sep!\') FROM "resource_images" "ri" WHERE "ri"."resource_id" = "r"."resource_id") AS "image_list"
        FROM "resources" as "r"
    ...
    const GET_ALL_TRANSACTION_LOGS = 'SELECT "ptl".*, "u"."fname", "u"."lname", "u"."email", SUM("total_refund_amount") as "refund_amount"
            ...
            GROUP BY "ptl"."payment_transaction_log_id", "u"."fname", "u"."lname", "u"."email"
    ...
    const GET_ALL_USERS_BY_STATUS =
        'SELECT "u".*,
            (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("p"."name", \'=\', "p"."value") ), \'!sep!\')
                        FROM "user_preferences" "p" WHERE "u"."user_id" = "p"."user_id") as "preferences",
            (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("cav"."custom_attribute_id", \'=\', "cav"."attribute_value") ), \'!sep!\')
                        FROM "custom_attribute_values" "cav" WHERE "cav"."entity_id" = "u"."user_id" AND "cav"."attribute_category" = 2) as attribute_list,
            (SELECT ARRAY_TO_STRING(ARRAY_AGG("ug"."group_id" ), \'!sep!\')
    ...
    const GET_ATTRIBUTES_BASE_QUERY = 'SELECT "a".*,
                (SELECT ARRAY_TO_STRING(ARRAY_AGG("e"."entity_id" ), \'!sep!\')
                            FROM "custom_attribute_entities" "e" WHERE "e"."custom_attribute_id" = "a"."custom_attribute_id" group by "e"."entity_id" ORDER BY "e"."entity_id") as "entity_ids",
                (CASE
                WHEN "a"."attribute_category" = 2 THEN (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("u"."fname", \' \', "u"."lname") ), \'!sep!\')
                                                    FROM "users" "u" ,"custom_attribute_entities" "e"
                                                    WHERE "e"."custom_attribute_id" = "a"."custom_attribute_id" AND "u"."user_id" = "e"."entity_id" group by "e"."entity_id" ORDER BY "e"."entity_id")
                WHEN "a"."attribute_category" = 4 THEN (SELECT ARRAY_TO_STRING(ARRAY_AGG("r"."name" ), \'!sep!\')
                                                    FROM "resources" "r" ,"custom_attribute_entities" "e"
                                                    WHERE "e"."custom_attribute_id" = "a"."custom_attribute_id" AND "r"."resource_id" = "e"."entity_id" group by "e"."entity_id" ORDER BY "e"."entity_id")
                WHEN "a"."attribute_category" = 5  THEN (SELECT ARRAY_TO_STRING(ARRAY_AGG("rt"."resource_type_name" ), \'!sep!\')
                                                    FROM "resource_types" "rt" ,"custom_attribute_entities" "e"
                                                    WHERE "e"."custom_attribute_id" = "a"."custom_attribute_id" AND "rt"."resource_type_id" = "e"."entity_id" group by "e"."entity_id" ORDER BY "e"."entity_id")
                ELSE null
                END) as "entity_descriptions",
                (CASE
                WHEN "a"."secondary_category" = 2 THEN (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT( "fname", \' \', "lname" ) ) , \'!sep!\' ) FROM "users" WHERE (FIND_IN_SET( "user_id"::text, "a"."secondary_entity_ids" ) > 0 ))
                WHEN "a"."secondary_category" = 4 THEN (SELECT ARRAY_TO_STRING(ARRAY_AGG("name"),  \'!sep!\' ) FROM "resources" WHERE (FIND_IN_SET( "resource_id"::text, "a"."secondary_entity_ids" ) > 0) )
                WHEN "a"."secondary_category" = 5 THEN (SELECT ARRAY_TO_STRING(ARRAY_AGG("resource_type_name"),  \'!sep!\' ) FROM "resource_types" WHERE (FIND_IN_SET( "resource_type_id"::text, "a"."secondary_entity_ids" ) > 0 ))
                ELSE null
    ...
    const GET_ATTRIBUTE_VALUES = 'SELECT "cav".*, "ca"."display_label", "ca"."admin_only"
    ...
    const GET_BLACKOUT_LIST =
        ...
        INNER JOIN "blackout_series" "bs" ON "bi"."series_id" = "bs"."series_id"
        INNER JOIN "blackout_series_resources" "bsr" ON  "bi"."series_id" = "bsr"."series_id"
    ...
    const GET_BLACKOUT_INSTANCES = 'SELECT * FROM "blackout_instances" WHERE "series_id" = @series_id';

    const GET_BLACKOUT_SERIES_BY_BLACKOUT_ID = 'SELECT *
        FROM "blackout_series" "bs"
        INNER JOIN "blackout_instances" "bi" ON "bi"."series_id" = "bs"."series_id"
        WHERE "blackout_instance_id" = @blackout_instance_id';
    ...
    const GET_BLACKOUT_RESOURCES = 'SELECT "r".*, "s"."admin_group_id" as "s_admin_group_id"
        ...
        WHERE "rr"."series_id" = @series_id
        ORDER BY "r"."name"';

    const GET_CUSTOM_LAYOUT = 'SELECT "l"."timezone", "l"."layout_type", "ctb".*
        FROM "layouts" "l"
    ...
    const GET_REMINDER_NOTICES = 'SELECT DISTINCT
        ...
        (SELECT ARRAY_TO_STRING(ARRAY_AGG("r"."name"  ), \'!sep!\')
    ...
    const GET_RESOURCES_PUBLIC = 'SELECT * FROM "resources" WHERE "allow_calendar_subscription" = TRUE AND "public_id" IS NOT NULL';
    ...
    const GET_SCHEDULES_PUBLIC = 'SELECT * FROM "schedules" WHERE "allow_calendar_subscription" = TRUE AND "public_id" IS NOT NULL';
    ...
    const UPDATE_BLACKOUT_INSTANCE = 'UPDATE "blackout_instances"
            SET "series_id" = @series_id, "start_date" = @startDate, "end_date" = @endDate
            WHERE "blackout_instance_id" = @blackout_instance_id';
...
class QueryBuilder
{
    ...
    public static $SELECT_LIST_FRAGMENT = '"ri".*, "rs"."date_created" as "date_created", "rs"."last_modified" as "last_modified", "rs"."description" as "description", "rs"."status_id" as "status_id", "rs"."title", "rs"."repeat_type", "rs"."repeat_options",
                    ...
                    (SELECT ARRAY_TO_STRING(ARRAY_AGG("groups"."group_id"), \',\')
                        FROM "user_groups" "groups" WHERE "owner"."user_id" = "groups"."user_id") as "owner_group_list",

                    (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("participants"."user_id", \'=\', CONCAT("participant_users"."fname", \' \', "participant_users"."lname")) ), \'!sep!\')
                    ...
                    (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("invitees"."user_id", \'=\', CONCAT("invitee_users"."fname", \' \', "invitee_users"."lname")) ), \'!sep!\')
                    ...
                    (SELECT ARRAY_TO_STRING(ARRAY_AGG(CONCAT("guests"."email", \'=\', "guests"."reservation_user_level") ), \'!sep!\')
